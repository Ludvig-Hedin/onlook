...
}: {defaultWidth?: number;minWidth?: number;maxWidth?: number;side?: 'left' | 'right';forceWidth?: number;}) {
...
export const ResizablePanel: React.FC<ResizablePanelProps> = ({
  ...
  return (
    <div
      ...
      {...props} data-oid="797c2f87db">
      
            <div className="h-full" data-oid="ec1cae9878">{children}</div>
            <div
        className={cn(
          'absolute top-0 h-full w-1 cursor-col-resize transition-all hover:bg-border/50 group/panel-hover:bg-border/30',
          side === 'left' ? 'right-0' : 'left-0'
        )}
        onMouseDown={handleMouseDown} data-oid="0022747cc2" />
