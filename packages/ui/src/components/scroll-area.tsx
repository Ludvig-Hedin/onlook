  ...
  return (
    <ScrollAreaPrimitive.Root
      ...
      {...props} data-oid="674e8ed970">
        ...
        className="focus-visible:ring-ring/50 size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1" data-oid="512c90f0b1">
