            ...
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props} data-oid="3f549c81c9">
                ...
                >
                    <SheetHeader className="sr-only" data-oid="3192f67e12">
                        ...
                        <SheetDescription data-oid="225de9b9ed">
                            Displays the mobile sidebar.
                        </SheetDescription>
                    </SheetHeader>
                    <div className="flex h-full w-full flex-col" data-oid="642db3ca2a">
                        {children}
                    </div>
                </SheetContent>
            </Sheet>
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
    ...
    return (
        ...
        >
            ...
            <span className="sr-only" data-oid="3263ac997b">
                Toggle Sidebar
            </span>
        </Button>
    );
...
const sidebarMenuButtonVariants = cva(
    'peer/menu-button hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:font-medium [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
    {
        variants: {
            variant: {
...
function SidebarMenuButton({
    ...
    return (
        <Tooltip data-oid="7e90d1c0e7">
            <TooltipTrigger asChild data-oid="8f7b86cb19">
                {button}
            </TooltipTrigger>
            <TooltipContent
                side="right"
