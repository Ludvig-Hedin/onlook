...
<svg
  ...
  {...props} data-oid="7384251ce6">
    ...
    strokeWidth="0.9375"
    strokeLinecap="round"
    strokeLinejoin="round" data-oid="1a598bf91b" />
    ...
    strokeWidth="0.9375"
    strokeLinecap="round"
    strokeLinejoin="round" data-oid="d16ce40bdb" />
    ...
    strokeWidth="0.9375"
    strokeLinecap="round"
    strokeLinejoin="round" data-oid="a8b8712d3c" />
    ...
    strokeWidth="0.9375"
    strokeLinecap="round"
    strokeLinejoin="round" data-oid="c81e759d6e" />
...
<svg
  ...
  {...props} data-oid="96d7bdbdba">
    ...
    fill="white"
    stroke="white" data-oid="8f87b07509" />
...
<svg
  ...
  xmlns="http://www.w3.org/2000/svg"
  className={className}
  {...props} data-oid="0321407507">
  
        <path
    d="M8 0.5H18C22.1421 0.5 25.5 3.85786 25.5 8V19.3242C25.5 22.7348 22.7348 25.5 19.3242 25.5C18.9905 25.5001 18.6689 25.6251 18.4229 25.8506L13 30.8213L7.57715 25.8506C7.33114 25.6251 7.00948 25.5001 6.67578 25.5C3.26519 25.5 0.5 22.7348 0.5 19.3242V8C0.5 3.85786 3.85786 0.5 8 0.5Z"
    fill="#444444"
    stroke="#666666" data-oid="2419ac8b58" />
...
const PercentageInput: React.FC<{
  ...
  return (
    <input
      ...
      title="Use ↑↓ arrows to adjust, Shift+↑↓ for ±10%" data-oid="4c461714ae" />);
...
export const Gradient: React.FC<GradientProps> = ({
  ...
  return (
    <div className={`flex flex-col gap-3 p-0 ${className}`} data-oid="43255234f5">
            {showPresets &&
      <div data-oid="b678c75da5">
                    <h4 className="text-sm font-medium text-foreground-primary mb-2 select-none px-3" data-oid="78508771c2">
                        Presets
                    </h4>
                    <div className="grid grid-cols-3 gap-2" data-oid="7dd2e69329">
          ...
          <button
            ...
            title={`Gradient ${index + 1}`} data-oid="4800eee2eb" />
            ...
            <div className="space-y-2" data-oid="aa10a3a41e">
                {showPresets &&
        <h4 className="text-sm font-medium text-foreground-primary mb-3 select-none" data-oid="5ea1372801">
                        Custom
                    </h4>
        }

                <div className="flex items-center justify-between px-3 pt-2" data-oid="8e5bc2ed6b">
                    <Select
            value={gradient.type}
            onValueChange={(value) =>
            onGradientChange({
              ...
              type: value as GradientState['type']
                        ...
                        <SelectTrigger
              size="sm"
              className="w-24 bg-background-secondary border-background-secondary px-2 text-xs rounded focus:outline-none focus:ring-0" data-oid="ce3db1ee17">
              
                            <SelectValue data-oid="2c8bc01cbe" />
                        </SelectTrigger>
                        <SelectContent className="rounded-md bg-background-secondary" data-oid="bbb83251d8">
                            <SelectItem
                value="linear"
                className="focus:bg-background-tertiary rounded-md text-xs cursor-pointer" data-oid="7056a8d0bc">
                
                                Linear
                            </SelectItem>
                            <SelectItem
                value="radial"
                className="focus:bg-background-tertiary rounded-md text-xs cursor-pointer" data-oid="61b447d9f7">
                
                                Radial
                            </SelectItem>
                            <SelectItem
                value="conic"
                className="focus:bg-background-tertiary rounded-md text-xs cursor-pointer" data-oid="b520914719">
                
                                Conic
                            </SelectItem>
                            <SelectItem
                value="angular"
                className="focus:bg-background-tertiary rounded-md text-xs cursor-pointer" data-oid="a5805292e7">
                
                                Angular
                            </SelectItem>
                            <SelectItem
                value="diamond"
                className="focus:bg-background-tertiary rounded-md text-xs cursor-pointer" data-oid="8a1e2cc9d1">
                    ...
                    <div className="flex items-center gap-0.5 ml-auto" data-oid="0d44d7dffc">
                        <Tooltip data-oid="d52ba44623">
                            <TooltipTrigger asChild data-oid="f672680af6">
                                <button
                  ...
                  title="Flip gradient" data-oid="e50ed77159">
                  
                                    <FlipIcon className="w-3.5 h-3.5" data-oid="f90acfc352" />
                                </button>
                            </TooltipTrigger>
                            <TooltipContent hideArrow className="mb-1" data-oid="be1e2eee4a">
                                <p data-oid="9c05859a80">Flip direction</p>
                            </TooltipContent>
                        </Tooltip>
                        <Tooltip data-oid="699e2f3870">
                            <TooltipTrigger asChild data-oid="f9c874b124">
                                <button
                  onClick={rotateGradient}
                  className="p-1.5 text-foreground-secondary hover:text-foreground-primary transition-colors hover:bg-background-hover rounded"
                  title="Rotate gradient" data-oid="cde2bbb170">
                  
                                    <Icons.Rotate className="w-3.5 h-3.5" data-oid="3ce839cf82" />
                                </button>
                            </TooltipTrigger>
                            <TooltipContent hideArrow className="mb-1" data-oid="9c06102260">
                                <p data-oid="625861116d">Rotate angle</p>
                            </TooltipContent>
                        </Tooltip>
                    </div>
                </div>

                <div className="relative px-3" data-oid="d218fb4e34">
                    <div className="flex items-center justify-between mb-3" data-oid="549f9c2645">
                        <span className="text-xs text-foreground-secondary select-none" data-oid="d6fd20d324">Stops</span>
                        <button
              onClick={addStop}
              ...
              title="Add stop" data-oid="36641c8678">
              
                            <Icons.Plus className="w-3.5 h-3.5" data-oid="ca69d87233" />
                        </button>
                    </div>
                    <div
            ref={trackRef}
            ...
            style={{
              ...
              return (
                <div
                  ...
                  title={`${stop.color} at ${stop.position.toFixed(1)}%`} data-oid="3364ada682">
                  
                                    <div className="relative w-full h-full" data-oid="6fae717627">
                                        {isSelected || isActive ?
                    <SelectedStopIcon className="w-7 h-7" data-oid="877fac55cd" /> :

                    <UnselectedStopIcon className="w-7 h-7" data-oid="8b8f80e574" />
                    }
                                        <div
                      className="absolute top-[3.5px] left-1/2 transform -translate-x-1/2 w-4 h-4 rounded border border-white/40"
                      style={{ backgroundColor: stop.color }} data-oid="576f2eca28" />
                ...
                <div className="space-y-0.5 mb-2" data-oid="fa51b1b252">
                    {gradient.stops.
            ...
            return (
              <div
                ...
                isSelected ? 'bg-background-active' : ''}`
                                    ...
                                    <div className="flex rounded items-center gap-0.5 flex-1" data-oid="733da19bcd">
                                        <PercentageInput
                    value={stop.position}
                    onChange={handlePositionChange}
                    className="mr-0.5"
                    onFocus={() => onStopSelect(stop.id)} data-oid="482906eae9" />
                  
                                        <div className="rounded overflow-hidden flex-1" data-oid="c668d6befd">
                                            <div className="rounded flex items-center gap-[1.5px] flex-1" data-oid="cc099682be">
                                                <div className="flex items-center gap-1 bg-background-secondary px-1 py-1 flex-1" data-oid="fbfa2561c6">
                                                    <Popover data-oid="1c9b8816b4">
                                                        <PopoverTrigger asChild data-oid="4dcf789416">
                                                            <button
                              className={`w-4.5 h-4.5 border cursor-pointer transition-all flex-shrink-0 rounded bg-white/10 ${
                              isSelected ?
                              'border-2 border-white shadow-lg' :
                              'border border-foreground-tertiary hover:border-foreground-secondary'} p-0`
                              }
                              style={{
                              ...
                              title={`Click to select (${stop.color.replace('#', '')})`} data-oid="bb84895799" />
                            
                                                        </PopoverTrigger>
                                                        <PopoverContent
                            className="w-[224px] overflow-hidden rounded-lg p-0 shadow-xl backdrop-blur-lg"
                            side="left"
                            align="center" data-oid="77d1abc32e">
                          ...
                          onClick={() => onStopSelect(stop.id)} data-oid="f9ccc63d5b">
                        ...
                        onFocus={() => onStopSelect(stop.id)} data-oid="774aa21383" />
                  ...
                  disabled={!canDelete} data-oid="dd4f472875">
                  
                                        <Icons.Minus className="w-3.5 h-3.5" data-oid="c7eb0aae43" />
                                    </button>
                                </div>);
