        ...
        <div className={`flex flex-col gap-3 p-0 ${className}`} data-oid="43255234f5">
            {showPresets && (
                <div data-oid="b678c75da5">
                    <h4
                        className="text-foreground-primary mb-2 px-3 text-sm font-medium select-none"
                        data-oid="78508771c2"
                    >
                        Presets
                    </h4>
            ...
            <div className="space-y-2" data-oid="aa10a3a41e">
                {showPresets && (
                    <h4
                        className="text-foreground-primary mb-3 text-sm font-medium select-none"
                        data-oid="5ea1372801"
                    >
                        Custom
                    </h4>
                ...
                <div className="flex items-center justify-between px-3 pt-2" data-oid="8e5bc2ed6b">
                    ...
                    >
                        ...
                        <SelectContent
                            className="bg-background-secondary rounded-md"
                            data-oid="bbb83251d8"
                        >
                            <SelectItem
                                value="linear"
                    ...
                    <div className="ml-auto flex items-center gap-0.5" data-oid="0d44d7dffc">
                        <Tooltip data-oid="d52ba44623">
                            <TooltipTrigger asChild data-oid="f672680af6">
                                <button
                                    ...
                                    data-oid="e50ed77159"
                                >
                                    <FlipIcon className="h-3.5 w-3.5" data-oid="f90acfc352" />
                                </button>
                            </TooltipTrigger>
                        ...
                        <Tooltip data-oid="699e2f3870">
                            <TooltipTrigger asChild data-oid="f9c874b124">
                                <button
                                    ...
                                    data-oid="cde2bbb170"
                                >
                                    <Icons.Rotate className="h-3.5 w-3.5" data-oid="3ce839cf82" />
                                </button>
                            </TooltipTrigger>
                ...
                <div className="relative px-3" data-oid="d218fb4e34">
                    <div className="mb-3 flex items-center justify-between" data-oid="549f9c2645">
                        <span
                            className="text-foreground-secondary text-xs select-none"
                            data-oid="d6fd20d324"
                        >
                            Stops
                        </span>
                        <button
                            ...
                            data-oid="36641c8678"
                        >
                            <Icons.Plus className="h-3.5 w-3.5" data-oid="ca69d87233" />
                        </button>
                    </div>
                    <div
                        ref={trackRef}
                        ...
                        {gradient.stops.map((stop) => {
                            ...
                            return (
                                <div
                                    ...
                                    data-oid="3364ada682"
                                >
                                    <div className="relative h-full w-full" data-oid="6fae717627">
                                        {isSelected || isActive ? (
                                            <SelectedStopIcon
                                                className="h-7 w-7"
                                                data-oid="877fac55cd"
                ...
                <div className="mb-2 space-y-0.5" data-oid="fa51b1b252">
                    {gradient.stops
                        ...
                        .map((stop) => {
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className="flex flex-1 items-center gap-0.5 rounded"
                                        data-oid="733da19bcd"
                                    >
                                        <PercentageInput
                                            value={stop.position}
                                        ...
                                        >
                                            <div
                                                className="flex flex-1 items-center gap-[1.5px] rounded"
                                                data-oid="cc099682be"
                                            >
                                                <div
                                                    className="bg-background-secondary flex flex-1 items-center gap-1 px-1 py-1"
                                                    data-oid="fbfa2561c6"
                                                >
