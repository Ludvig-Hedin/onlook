...
export const Icons = {
    ...
    WeblabLogo: ({ className, ...props }: IconProps) => (
        <BrandSymbol className={className} {...props} />
    ),

    WeblabIcon: ({ className, ...props }: IconProps) => (
        <BrandSymbol className={className} {...props} />
    ),

    WeblabTextLogo: ({ className, ...props }: IconProps) => (
        <BrandWordmark className={className} {...props} />
    ),

    WeblabFullLogo: ({ className, ...props }: IconProps) => (
        ...
        >
            <defs data-oid="0b5b7c5737">
                ...
                >
                    <stop
                        offset="0"
                        style={{ stopColor: 'rgb(42, 43, 43)' }}
                        data-oid="78382d85e1"
                    ></stop>
                    <stop
                        offset="0.611"
                        style={{ stopColor: 'rgb(154, 155, 154)' }}
                        data-oid="7c8db2bc29"
                    ></stop>
                    <stop
                        offset="1"
    ...
    CursorLogo: ({ className, ...props }: IconProps) => (
        ...
        >
            <path
                d="M0 4.5375L7.56101 0.199219V4.5375H0Z"
                fill="url(#paint0_linear_3223_92799)"
                data-oid="0069af0820"
            />
            <path
            ...
            <path
                d="M0 4.53724L7.49903 8.9375L14.9981 4.53724H0Z"
                fill="white"
                data-oid="e12dc37c90"
            />
            <path
                d="M7.5 8.93829V17.8008L14.999 4.53803L7.5 8.93829Z"
                fill="#E4E4E4"
                data-oid="43428fb694"
            />
    ...
    EmptyState: ({ className, ...props }: IconProps) => (
        ...
        >
            ...
            <defs data-oid="2d9d92eff4">
                ...
                >
                    <stop
                        className="[stop-color:var(--color-gray-50)] dark:[stop-color:var(--color-gray-700)]"
                        data-oid="167ca29472"
                    />
                    <stop
                        offset="1"
    ...
    MarginBL: ({ className, ...props }: IconProps) => (
        ...
        >
            ...
            <path
                d="M12.5 2.25L5.5 2.25"
                stroke="#494949"
                strokeLinecap="round"
                data-oid="c510200012"
            />
            <path
                d="M15.75 5.5L15.75 12.5"
                stroke="#494949"
                strokeLinecap="round"
                data-oid="c0a240029e"
            />
