  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        <ChevronLeftIcon className={cn('size-4', className)} {...props} data-oid="a40433e8ff" />,

        IconRight: ({ className, children: _children, ...props }) =>
        <ChevronRightIcon className={cn('size-4', className)} {...props} data-oid="41e2035522" />

      }}
      {...props} data-oid="4edd36cbaf" />);
