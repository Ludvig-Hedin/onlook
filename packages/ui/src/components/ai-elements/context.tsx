  ...
  return (
    <svg
      ...
      width="20" data-oid="9f4b8c2b88">
        ...
        r={ICON_RADIUS}
        stroke="currentColor"
        strokeWidth={ICON_STROKE_WIDTH} data-oid="63bce590ba" />
        ...
        style={{ transformOrigin: 'center', transform: 'rotate(-90deg)' }} data-oid="6170e5e326" />
  ...
  return (
    <HoverCardTrigger asChild data-oid="3bac57f0d9">
      ...
      <Button type="button" variant="ghost" {...props} data-oid="d91ff3d708">
                    ...
                    <span className="text-xs font-medium text-muted-foreground" data-oid="d85b511f5a">
                        {renderedPercent}
                    </span>
                </Button>
      }
...
export const ContextContentHeader = ({ children, className, ...props }: ContextContentHeader) => {
  ...
  return (
    <div className={cn('w-full space-y-2 p-3', className)} {...props} data-oid="21a748af5f">
            {children ??
      <>
                    <div className="flex items-center justify-between gap-3 text-xs" data-oid="6078214c76">
                        <p data-oid="62788d78bf">{displayPct}</p>
                        <p className="font-mono text-muted-foreground" data-oid="7a19df4ef8">
                            {used} / {total}
                        </p>
                    </div>
                    <div className="space-y-2" data-oid="5b726c182b">
                        <Progress
            className="bg-muted"
            value={Math.round(usedPercent * PERCENT_MAX)} data-oid="3c852e12d6" />
...
export const ContextContentFooter = ({ children, className, ...props }: ContextContentFooter) => {
  ...
  return (
    <div
      ...
      {...props} data-oid="cd82ef66bc">
      
            {children ??
      <>
                    <span className="text-muted-foreground" data-oid="8cfb3df7e6">Total cost</span>
...
export const ContextInputUsage = ({ className, children, ...props }: ContextInputUsageProps) => {
  ...
  return (
    <div className={cn('flex items-center justify-between text-xs', className)} {...props} data-oid="97f2f5617e">
            <span className="text-muted-foreground" data-oid="e5b2b62113">Input</span>
...
export const ContextOutputUsage = ({ className, children, ...props }: ContextOutputUsageProps) => {
  ...
  return (
    <div className={cn('flex items-center justify-between text-xs', className)} {...props} data-oid="277ccf9758">
            <span className="text-muted-foreground" data-oid="a81a264ef7">Output</span>
...
export const ContextReasoningUsage = ({
  ...
  return (
    <div className={cn('flex items-center justify-between text-xs', className)} {...props} data-oid="a5edc379a6">
            <span className="text-muted-foreground" data-oid="746c58d52a">Reasoning</span>
            <TokensWithCost costText={reasoningCostText} tokens={reasoningTokens} data-oid="6c1ecceb8d" />
        </div>);
...
export const ContextCacheUsage = ({ className, children, ...props }: ContextCacheUsageProps) => {
  ...
  return (
    <div className={cn('flex items-center justify-between text-xs', className)} {...props} data-oid="08203b7053">
            <span className="text-muted-foreground" data-oid="71b205de69">Cache</span>
...
}: {tokens?: number;costText?: string;showCost?: boolean;}) => {
  return (
    <span data-oid="9c358ff8c7">
      ...
      new Intl.NumberFormat('en-US', {
        notation: 'compact'
            ...
            {showCost && costText ?
      <span className="ml-2 text-muted-foreground" data-oid="d59c386137">• {costText}</span> :
      null}
        </span>);
