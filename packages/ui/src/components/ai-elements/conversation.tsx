...
<div
  ...
  {...props} data-oid="e542cae42f">
  
        {children ??
  <>
                {icon && <div className="text-muted-foreground" data-oid="947647d56b">{icon}</div>}
                <div className="space-y-1" data-oid="bda77b9e2e">
                    <h3 className="font-medium text-sm" data-oid="0834be957a">{title}</h3>
                    {description && <p className="text-muted-foreground text-sm" data-oid="001cdffc00">{description}</p>}
                </div>
            </>
  }
    </div>;
