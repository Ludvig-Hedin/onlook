...
export const InviteUserEmail = ({
    ...
    const previewText = `Join ${invitedByName ?? invitedByEmail} on Weblab`;
    const headingText = `Join ${invitedByName ?? invitedByEmail} on Weblab`;
                ...
                <Body className="mx-auto my-auto bg-white px-2 font-sans" data-oid="de00219db1">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-black" data-oid="cb61f2cbb0">
                                {inviteeEmail}
                            </span>
