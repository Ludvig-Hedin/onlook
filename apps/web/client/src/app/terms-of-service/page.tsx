                ...
                <div className="max-w-4xl mx-auto px-8 py-16">
                    ...
                    <div className="prose prose-invert max-w-none">
                        <p className="text-foreground-secondary mb-8">
                            If you have any questions, please write to us at contact@weblab.build
                        </p>
                        ...
                        <p className="text-foreground-secondary mb-6">
                            Access to the Service. Subject to User's compliance with this Agreement (including the Registration) Weblab grants User a nonexclusive, non-sublicensable, non-transferable right and license to access and use the Weblab product(s) and/or service(s) (the "Services") solely for User's internal business purposes. User (i) agrees to use the Services in compliance with all applicable local, state, national and foreign laws, treaties and regulations in connection with User's use of the Service (including those related to data privacy, international communications, export laws and the transmission of technical or personal data laws), and (ii) agrees not to use the Service in a manner that violates any third party intellectual property, contractual or other proprietary rights. User agrees to maintain the confidentiality of its access credentials and other account information, and to be responsible for any and all activities under its account. Unless separately agreed in writing, Weblab is under no obligation to provide support for the Service.
                        </p>

                        <h2 className="text-2xl font-light text-foreground-primary mt-12 mb-6">2. Fees; Payment</h2>
                        <p className="text-foreground-secondary mb-6">
                            User agrees to pay Weblab the fees as set forth in the Registration, if any ("Fees"). Unless otherwise specified in the Registration, all Fees will be invoiced annually in advance and all invoices issued under this Agreement are payable in U.S. dollars within thirty (30) days from date of invoice. Past due invoices are subject to interest on any outstanding balance of the lesser of 1.5% per month or the maximum amount permitted by law. User will be responsible for all taxes associated with its use of the Services (excluding taxes based on Weblab's net income).
                        </p>

                        <h2 className="text-2xl font-light text-foreground-primary mt-12 mb-6">3. Ownership; Feedback</h2>
                        <p className="text-foreground-secondary mb-6">
                            Weblab owns and retains all right, title, and interest in and to the Services, and all configuration tools, modules, software, products, works, and other intellectual property and moral rights related thereto or created, used, or provided by Weblab for the purposes of this Agreement, including any content or trademarks text, graphics, user and visual interfaces, photographs, logos, sounds, music, artwork, applications, computer code and associated documentation, the design, structure, arrangement, and "look and feel" of such content, and any improvements, updates, enhancements, copies and derivative works of the foregoing. Any software, tools and other materials distributed or otherwise provided to User (including without limitation any software identified in the Registration) will be deemed a part of the "Services" and subject to all of the terms and conditions of this Agreement. No rights or licenses are granted to User except as expressly and unambiguously set forth in this Agreement. User may (but is not obligated to) provide suggestions, comments or other feedback to Weblab with respect to the Service ("Feedback"). User agrees that Weblab will be free to use the Feedback for any purpose without any further accounting to User.
                        </p>

                        <h2 className="text-2xl font-light text-foreground-primary mt-12 mb-6">4. Restrictions</h2>
                        <p className="text-foreground-secondary mb-6">
                            User agrees that it will not, directly or indirectly: (i) reverse engineer, decompile, disassemble, or otherwise attempt to discover the source code, object code, or underlying structure, ideas, or algorithms of the Service (except to the extent applicable laws specifically prohibit such restriction); (ii) modify, translate, or create derivative works based on the Service; (iii) copy, rent, lease, distribute, pledge, assign, or otherwise transfer or encumber rights to the Service; (iv) use the Service for the benefit of a third party; (v) remove or otherwise alter any proprietary notices or labels from the Service or any portion thereof; (vi) use the Service to build an application or product that is competitive with any Weblab product or service; (vii) interfere or attempt to interfere with the proper working of the Service or any activities conducted on the Service; (viii) bypass any measures Weblab may use to prevent or restrict access to the Service (or other accounts, computer systems or networks connected to the Service).
                        </p>

                        <h2 className="text-2xl font-light text-foreground-primary mt-12 mb-6">5. User Data</h2>
                        <p className="text-foreground-secondary mb-6">
                            a. "User Data" means any data or information provided, uploaded, or submitted by User to the Service. User retains all right, title and interest in and to the User Data, including all intellectual property rights therein. User represents and warrants that it has all rights necessary to provide the User Data to Weblab as contemplated hereunder, in each case without any infringement, violation or misappropriation of any third-party rights (including, without limitation, intellectual property rights and rights of privacy).
                        </p>
                        <p className="text-foreground-secondary mb-6">
                            b. Except for contact and payment information provided for the purpose of registering for the Service, User agrees that Weblab does not wish to receive or agree to receive any personal information, financial information, protected health information or any other sensitive information regarding User or User's customers, and User agrees not to upload or transmit to Weblab any such information without the prior written consent of Weblab.
                        </p>
                        <p className="text-foreground-secondary mb-6">
                            c. Weblab will use and modify User Data only for the purpose of providing, maintaining and improving the Services and User hereby grants Weblab all licenses necessary to do so. In addition, unless User opts out using the user settings prior to providing the User Data to Weblab, Weblab may also use the User Data for the development and commercialization of models, algorithms, tools and related artificial intelligence products, which development activities may include, without limitation, training artificial intelligence models.
                        </p>
                        <p className="text-foreground-secondary mb-6">
                            d. In the course of providing the Service, Weblab may also collect statistical data and performance information, analytics, meta-data or similar information, generated through instrumentation and logging systems, regarding the operation of the Service, including User's use of the Service (the "Platform Data"). Weblab may use the Platform Data for any internal business purpose (including without limitation, for purposes of improving, testing, artificial intelligence model training, operating, promoting and marketing Weblab's products and services), provided however, that (i) Platform Data will not include any User Data, and (ii) Weblab will not disclose Platform Data to any third party in a manner that allows such third party to identify User.
                        </p>

                        <h2 className="text-2xl font-light text-foreground-primary mt-12 mb-6">6. Communications</h2>
                        <p className="text-foreground-secondary mb-6">
                            You agree that Weblab may send you emails concerning our products and services, as well as those of third parties. You may opt out of promotional emails by responding to the promotional email itself or emailing us at contact@weblab.build.
                        </p>

                        <h2 className="text-2xl font-light text-foreground-primary mt-12 mb-6">7. Suspension; Termination</h2>
                        <p className="text-foreground-secondary mb-6">
                            User agrees that Weblab may terminate or suspend User's access to the Services at any time in its sole discretion if it suspects that User is in breach of this Agreement.
                        </p>

                        <h2 className="text-2xl font-light text-foreground-primary mt-12 mb-6">8. Indemnification</h2>
                        <p className="text-foreground-secondary mb-6">
                            User agrees to defend, indemnify, and hold harmless Weblab, its affiliates and each of its and its affiliates' employees, contractors, directors, suppliers and representatives from all liabilities, claims, and expenses paid or payable to an unaffiliated third party (including reasonable attorneys' fees), that arise from or relate to any claim (i) that the User Data or any Configuration infringes, violates, or misappropriates any third party intellectual property or proprietary right or (ii) based on User's breach of this Agreement.
                        </p>
