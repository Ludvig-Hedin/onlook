        ...
        faqs: [
            {
                ...
                answer: "Weblab works with React, Next.js, Vue, Angular, Svelte, Preact, SolidJS, Qwik, and Web Components. If your framework works with modern component-based architecture, it likely works with Weblab."
            },
            {
            ...
            },
            {
                ...
                answer: "Weblab works with all major component libraries including shadcn/ui, Material UI, Mantine, Chakra UI, Radix UI, Ant Design, Headless UI, Blueprint, Fluent UI, and PrimeReact. If your components work in your codebase, they work in Weblab."
            },
            {
        ...
        faqs: [
            {
                ...
                answer: "Both the founders come from either side of the design and development divide. We realized that AI could be the final leap to solve the problem of designers and developers working together. Weblab is a continuous iteration towards the new state-of-the-art for collaboration in code."
            },
            {
            ...
            },
            {
                ...
                answer: "Weblab was founded in Cincinnati, Ohio, USA, and started as a remote-first company between Cincinnati and New York City. After the YC Winter 2025 batch, Weblab opened a barracks in San Francisco. Our open-source contributors are scattered across the world, bringing their unique perspectives and incredible talent to the project as we continue to push the limits of design and development."
            }
        ]
    }
];
    ...
    return (
        <WebsiteLayout showFooter={true}>
            ...
            <section className="sr-only" aria-label="FAQ Summary">
                ...
                <p>
                    Weblab is an AI-powered visual editor for frontend development. It connects to existing
