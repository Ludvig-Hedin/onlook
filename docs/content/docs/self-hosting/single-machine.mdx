...
description: Deploy Weblab on a single VM or machine using standalone build for production
---

# Single Machine Deployment

Deploy Weblab on a single virtual machine or physical server using the standalone build. This creates a self-contained production deployment without Docker containers, ideal for small teams and simple production setups.
