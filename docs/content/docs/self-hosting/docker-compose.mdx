...
Deploy Weblab using Docker Compose on VMs or local machines. This is a simple, single-container deployment designed for small teams and basic self-hosting needs. For enterprise-grade deployments requiring high availability and scalability, use the [Cloud Deployment](/self-hosting/cloud-deployment) option.
