...
description: External services for Weblab
---

# External Services

Weblab requires several external services to provide its features. Each of these services is self-hostable under Apache 2.0 or equivalently permissive licenses.

## Self-hosting External Services

For assistance with self-hosting these services, please contact us at [founders@weblab.build](mailto:founders@weblab.build).
...
1. Update the providers in [`packages/ai/src/chat/providers.ts`](https://github.com/weblab.build/blob/main/packages/ai/src/chat/providers.ts). We already support Anthropic and OpenRouter as examples. You can follow the same format to add a new provider.
