---
title: Figma to Weblab
description: Export Figma designs directly into Weblab
---

# Figma to Weblab

Export Figma designs directly into Weblab. No developers needed. This guide shows you how to structure your design, export it, and turn it into a working React application with Weblab.

{/* ![Figma to Weblab Banner](/images/figma-to-onlook-banner.png) */}
*Transform your Figma designs into working code with Weblab*

## Why This Integration Changes Everything

Designers no longer have to stop at mockups. With Weblab, you can:
...
### 2. Import into Weblab

1. Export your Figma design as SVG or PNG
2. Open Weblab and create a new project
3. Import your design assets
4. Use Weblab's tools to recreate the design as React components
