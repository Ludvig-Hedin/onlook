...
description: Technical documentation for Weblab
---

# Developer Docs & Contributing

This section provides technical documentation for developers who want to understand Weblab's architecture, contribute to the project, or extend its functionality.

## Overview

Weblab is structured as a monorepo with several interconnected apps and packages, primarily built using Next.js, React, TypeScript, and Vite.

## Contributing to Weblab

We welcome contributions to Weblab! This guide will help you get started with contributing to the project.

When contributing to this repository, please first discuss the change you wish to make via [issues](https://github.com/weblab.build/issues),
[Discord](https://discord.gg/hERDfFZCsH), [email](mailto:contact@weblab.build), or any other method with the owners of this repository before making a change. 

Please note we have a [code of conduct](https://github.com/weblab.build/blob/main/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
