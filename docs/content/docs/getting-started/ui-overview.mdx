---
title: UI Overview
description: Overview of the Weblab user interface
---

# UI Overview

Weblab's interface is designed to be intuitive for designers while providing powerful capabilities for editing React components.

## Main Interface Areas

The Weblab interface is divided into several key areas:
...
Weblab provides various keyboard shortcuts to speed up your workflow:
